...
oPaginate:{sFirst:"Первая",sLast:"Последняя",sNext:"Следующая",sPrevious:"Предыдущая"},sEmptyTable:"Данные таблицы недостапны",sInfo:"Показано _START_ из _END_ всего из _TOTAL_ записей",sInfoEmpty:"Показано 0 из 0 всего из 0 записей",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Отображать _MENU_ записей",sLoadingRecords:"Загрузка...",sProcessing:"Загрузка...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Соответствующих записей не найдено"},oSearch:h.extend({},
